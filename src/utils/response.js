 ...
 */
export function successResponse(res, data = "Request successful", message = "Success", pagination = null) {
 ...
 */
export function createdResponse(res, data = "Resource created successfully", message = "Success") {
